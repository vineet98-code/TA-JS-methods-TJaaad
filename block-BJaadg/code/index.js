...
var index =quote.charAt(indexOfIs);
/*
...
let result = from.concat(` said ${quote} to ${to}`);
/*
...
let sentence = quoteSplitted.indexOf("today");
quoteSplitted[sentence] = "tomorrow";
quoteSplitted.join(" ");
...
*/
let startNewQuote = ".".repeat(max - length) + quote;
