...
if(fruits[0] === 'Dragon Fruits' && Fruits[1] === 'Guava'){
    console.log(true);
} else {
    console.log(false);
}
...
let allFruits = fruits.forEach((fruit) => console.log(fruit.toLowerCase()));
...
let num1 = numbers.flat(Infinity);

// Convert the numbersTwo array to one level element. Remove all sub-arrays to individual elements and log them.
// (for multiple level flat accepts argument by default it's 1 `array.flat(2)`)

let num2= numbersTwo.flat(Infinity);
console.log(num2);

// Convert the numbersThree array to one level element.
// Remove all sub-arrays to individual elements, log them and update the value of numbersThree to the new flat array.
var newFlatArray = numbersThree.flat(5);
...
let doubleNumbers = newFlatArray.map(x => x * 2);

// Create a new variable named tripleNumbers that store the numberThree array (each element should be multiplied by 3). Use map

let tripleNumbers = newFlatArray.map(x => x * 3);

// Create a new variable named halfNumbers that store the numberThree array (each element should be divided by 2). Use map

let halfNumbers = newFlatArray.map(x => x / 2);
